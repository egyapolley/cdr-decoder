...
records_defs = {
             ...
             'children': {
                 ...
                 16: {'name': 'diagnostics', 'type': 'Diagnostics', 'OPTIONAL': 'yes',
                      'children': {0: {'name': 'gsm0408Cause', 'type': 'INTEGER', },
                                   ...
                                   5: {'name': 'positionMethodFailureCause',
                                       'type': 'PositionMethodFailure-Diagnostic'},
                                   6: {'name': 'unauthorizedLCSClientCause',
                                       'type': 'UnauthorizedLCSClient-Diagnostic'},
                 ...
                 28: {'name': 'pSFurnishChargingInformation', 'type': 'PSFurnishChargingInformation',
                      'OPTIONAL': 'yes'},
                 ...
                 34: {'name': 'listOfServiceData', 'type': 'SEQUENCE OF ChangeOfServiceCondition', 'OPTIONAL': 'yes',
                      'children': {16: {'name': 'ChangeOfServiceCondition', 'type': 'SEQUENCE',
                                        'children': {
                                            ...
                                            2: {'name': 'chargingRuleBaseName', 'type': 'ChargingRuleBaseName',
                                                'OPTIONAL': 'yes'},
                                            3: {'name': 'resultCode', 'type': 'ResultCode', 'OPTIONAL': 'yes'},
                                            4: {'name': 'localSequenceNumber', 'type': 'LocalSequenceNumber',
                                                'OPTIONAL': 'yes'},
                                            ...
                                            9: {'name': 'qoSInformationNeg', 'type': 'EPCQoSInformation',
                                                'OPTIONAL': 'yes',
                                                'children': {
                                                    1: {'name': 'qCI', 'type': 'INTEGER', },
                                                    2: {'name': 'maxRequestedBandwithUL', 'type': 'INTEGER',
                                                        'OPTIONAL': 'yes', },
                                                    3: {'name': 'maxRequestedBandwithDL', 'type': 'INTEGER',
                                                        'OPTIONAL': 'yes', },
                                                    4: {'name': 'guaranteedBitrateUL', 'type': 'INTEGER',
                                                        'OPTIONAL': 'yes', },
                                                    5: {'name': 'guaranteedBitrateDL', 'type': 'INTEGER',
                                                        'OPTIONAL': 'yes', },
                                                    6: {'name': 'aRP', 'type': 'INTEGER', 'OPTIONAL': 'yes', },
                                                    7: {'name': 'aPNAggregateMaxBitrateUL', 'type': 'INTEGER',
                                                        'OPTIONAL': 'yes', },
                                                    8: {'name': 'aPNAggregateMaxBitrateDL', 'type': 'INTEGER',
                                                        'OPTIONAL': 'yes', },
                                                }},
                                            10: {'name': 'servingNodeAddress', 'type': 'GSNAddress', 'OPTIONAL': 'yes',
                                                 'children': {0: {'name': 'GSNAddress', 'type': 'IPAddress'}}},
                                            12: {'name': 'datavolumeFBCUplink', 'type': 'DataVolumeGPRS',
                                                 'OPTIONAL': 'yes'},
                                            13: {'name': 'datavolumeFBCDownlink', 'type': 'DataVolumeGPRS',
                                                 'OPTIONAL': 'yes'},
                                            14: {'name': 'timeOfReport', 'type': 'TimeStamp'},
                                            16: {'name': 'failureHandlingContinue', 'type': 'FailureHandlingContinue',
                                                 'OPTIONAL': 'yes'},
                                            17: {'name': 'serviceIdentifier', 'type': 'ServiceIdentifier',
                                                 'OPTIONAL': 'yes'},
                                            18: {'name': 'pSFurnishChargingInformation',
                                                 'type': 'PSFurnishChargingInformation', 'OPTIONAL': 'yes'},
                                            19: {'name': 'aFRecordInformation',
                                                 'type': 'SEQUENCE OF AFRecordInformation', 'OPTIONAL': 'yes'},
                                            20: {'name': 'userLocationInformation', 'type': 'OCTET STRING',
                                                 'OPTIONAL': 'yes'},
                                            21: {'name': 'eventBasedChargingInformation',
                                                 'type': 'EventBasedChargingInformation', 'OPTIONAL': 'yes'},
                                            22: {'name': 'timeQuotaMechanism', 'type': 'TimeQuotaMechanism',
                                                 'OPTIONAL': 'yes'},
                                            23: {'name': 'serviceSpecificInfo',
                                                 'type': 'SEQUENCE OF ServiceSpecificInfo', 'OPTIONAL': 'yes'},
                                            24: {'name': 'threeGPP2UserLocationInformation', 'type': 'OCTET STRING',
                                                 'OPTIONAL': 'yes'},
                                            25: {'name': 'sponsorIdentity', 'type': 'OCTET STRING', 'OPTIONAL': 'yes'},
                                            26: {'name': 'applicationServiceProviderIdentity', 'type': 'OCTET STRING',
                                                 'OPTIONAL': 'yes'},
                                            27: {'name': 'aDCRuleBaseName', 'type': 'ADCRuleBaseName',
                                                 'OPTIONAL': 'yes'},
                                            28: {'name': 'presenceReportingAreaStatus',
                                                 'type': 'PresenceReportingAreaStatus', 'OPTIONAL': 'yes'},
                                            29: {'name': 'userCSGInformation', 'type': 'UserCSGInformation',
                                                 'OPTIONAL': 'yes'},
                                        }, }}
                      },
    ...
    'sGWRecord': {
        78: {'name': 'sGWRecord', 'type': 'SET',
             'children': {
                 0: {'name': 'recordType', 'type': 'RecordType',
                     'values': {55: 'SGWRecord'}},
                 3: {'name': 'servedIMSI', 'type': 'IMSI', 'OPTIONAL': 'yes'},
                 4: {'name': 's-GWAddress', 'type': 'GSNAddress',
                     'children': {0: {'name': 'IPAddress', 'type': 'IPAddress'}, }},
                 5: {'name': 'chargingID', 'type': 'ChargingID'},
                 6: {'name': 'servingNodeAddress', 'type': 'SEQUENCE OF GSNAddress',
                     'children': {0: {'name': 'IPAddress', 'type': 'IPAddress'}, }},
                 ...
                 11: {'name': 'dynamicAddressFlag', 'type': 'DynamicAddressFlag', 'OPTIONAL': 'yes', },
                 12: {'name': 'listOfTrafficVolumes', 'type': 'SEQUENCE OF ChangeOfCharCondition', 'OPTIONAL': 'yes',
                      'children': {16: {'name': 'ChangeOfCharCondition', 'type': 'SEQUENCE',
                                        'children': {
                                            3: {'name': 'datavolumeFBCUplink', 'type': 'DataVolumeGPRS',
                                                'OPTIONAL': 'yes'},
                                            4: {'name': 'datavolumeFBCDownlink', 'type': 'DataVolumeGPRS',
                                                'OPTIONAL': 'yes'},
                                            5: {'name': 'changeCondition', 'type': 'ChangeCondition',
                                                'OPTIONAL': 'yes'},
                                            6: {'name': 'changeTime', 'type': 'TimeStamp',
                                                'OPTIONAL': 'yes'},
                                            8: {'name': 'userLocationInformation', 'type': 'OCTET STRING',
                                                'OPTIONAL': 'yes'},
                                            9: {'name': 'ePCQoSInformation', 'type': 'EPCQoSInformation',
                                                'OPTIONAL': 'yes',
                                                'children': {
                                                    1: {'name': 'qCI', 'type': 'INTEGER'},
                                                    2: {'name': 'maxRequestedBandwithUL', 'type': 'INTEGER',
                                                    ...
                                                    5: {'name': 'guaranteedBitrateDL', 'type': 'INTEGER',
                                                        'OPTIONAL': 'yes'},
                                                    6: {'name': 'aRP', 'type': 'INTEGER',
                                                        'OPTIONAL': 'yes'},
                                                    7: {'name': 'aPNAggregateMaxBitrateUL', 'type': 'INTEGER',
                                                        'OPTIONAL': 'yes'},
                                                    8: {'name': 'aPNAggregateMaxBitrateDL', 'type': 'INTEGER',
                                                        'OPTIONAL': 'yes'},
                                                    9: {'name': 'extendedMaxRequestedBWUL', 'type': 'INTEGER',
                                                        'OPTIONAL': 'yes'},
                                                    10: {'name': 'extendedMaxRequestedBWDL', 'type': 'INTEGER',
                                                         'OPTIONAL': 'yes'},
                                                    11: {'name': 'extendedGBRUL', 'type': 'INTEGER',
                                                         'OPTIONAL': 'yes'},
                                                    12: {'name': 'extendedGBRDL', 'type': 'INTEGER',
                                                         'OPTIONAL': 'yes'},
                                                    13: {'name': 'extendedAPNAMBRUL', 'type': 'INTEGER',
                                                         'OPTIONAL': 'yes'},
                                                    14: {'name': 'extendedAPNAMBRDL', 'type': 'INTEGER',
                                                         'OPTIONAL': 'yes'},
                 ...
                 31: {'name': 'mSTimeZone', 'type': 'MSTimeZone', 'OPTIONAL': 'yes'},
                 32: {'name': 'userLocationInformation', 'type': 'OCTET STRING', 'OPTIONAL': 'yes'},
                 34: {'name': 'sGWChange', 'type': 'SGWChange', 'OPTIONAL': 'yes'},
                 35: {'name': 'servingNodeType', 'type': 'SEQUENCE OF ServingNodeType',
                      'children': {10: {'name': 'servingNodeType', 'type': 'ENUMERATED'}, }},
                 36: {'name': 'p-GWAddressUsed', 'type': 'GSNAddress',
                      'children': {0: {'name': 'IPAddress', 'type': 'IPAddress'}, }},
                 37: {'name': 'p-GWPLMNIdentifier', 'type': 'PLMN-Id', 'OPTIONAL': 'yes'},
                 38: {'name': 'startTime', 'type': 'TimeStamp', 'OPTIONAL': 'yes'},
                 39: {'name': 'stopTime', 'type': 'TimeStamp', 'OPTIONAL': 'yes'},
                 40: {'name': 'pDNConnectionChargingID', 'type': 'ChargingID', 'OPTIONAL': 'yes'},
                 43: {'name': 'servedPDPPDNAddressExt', 'type': 'PDPAddress', 'OPTIONAL': 'yes'},
                 44: {'name': 'lowPriorityIndicator', 'type': 'NULL', 'OPTIONAL': 'yes'},
                 47: {'name': 'dynamicAddressFlagExt', 'type': 'DynamicAddressFlag', 'OPTIONAL': 'yes'},
                 48: {'name': 's-GWiPv6AddressUsed', 'type': 'GSNAddress', 'OPTIONAL': 'yes'},
                 51: {'name': 'tWANUserLocationInformation', 'type': 'TWANUserLocationInfo', 'OPTIONAL': 'yes'},
                 52: {'name': 'retransmission', 'type': 'NULL', 'OPTIONAL': 'yes'},
                 53: {'name': 'userLocationInfoTime', 'type': 'TimeStamp', 'OPTIONAL': 'yes'},
                 54: {'name': 'cNOperatorSelectionEnt', 'type': 'CNOperatorSelectionEntity', 'OPTIONAL': 'yes'},
...
FileClosureTriggerReasons = {
    ...
    81: 'CDR release, version or encoding change.',
    82: 'CDR release, version or encoding change.',
